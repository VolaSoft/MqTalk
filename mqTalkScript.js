...
//GLOBAL VARIABLES
	...
	var myPort = 8000;
	var myClientId = "MqTalk";
	var myTopic = "mqtalktest";
	var myMessageToSend;
	var lastMessage;
...
function send_message(object){
		var actualMessage = document.getElementById(object).value;
...
function beep(){
    ...
    //snd.play();
    var snd = new Audio("audios/beep.mp3");  
    snd.play();
}
...
function displayMessage(message){
	var innerContainer = document.getElementById('container').innerHTML;
	var messageClientId = message.substring(0, message.indexOf(':#:') + 0);
